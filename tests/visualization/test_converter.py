...
class TestConverter(TestCase):
    ...
    def test_cobra2networkx(self):
        ...
        expected_edges = [
            ...
            ("coa_c", "SUCOAS"),
            ("dhap_c", "TPI"),
            ("e4p_c", "Biomass_Ecoli_core"),
            ("e4p_c", "TKT2"),
            ("etoh_c", "ALCD2x"),
            ("etoh_e", "ETOHt2r"),
            ("etoh_e", "EX_etoh_e"),
            ("f6p_c", "Biomass_Ecoli_core"),
            ("f6p_c", "PFK"),
            ("fdp_c", "FBA"),
            ("fdp_c", "FBP"),
            ("for_c", "FORti"),
            ...
            ("fum_e", "EX_fum_e"),
            ("fum_e", "FUMt2_2"),
            ("g3p_c", "Biomass_Ecoli_core"),
            ("g3p_c", "GAPD"),
            ("g3p_c", "TALA"),
            ("g6p_c", "Biomass_Ecoli_core"),
            ("g6p_c", "G6PDH2r"),
            ("g6p_c", "PGI"),
            ("glc__D_e", "EX_glc__D_e"),
            ("glc__D_e", "GLCpts"),
            ("gln__L_c", "Biomass_Ecoli_core"),
            ("gln__L_c", "GLUN"),
            ("gln__L_c", "GLUSy"),
            ("gln__L_e", "EX_gln__L_e"),
            ("gln__L_e", "GLNabc"),
            ("glu__L_c", "Biomass_Ecoli_core"),
            ("glu__L_c", "GLNS"),
            ("glu__L_c", "GLUDy"),
            ("glu__L_e", "EX_glu__L_e"),
            ("glu__L_e", "GLUt2r"),
            ("glx_c", "MALS"),
            ("h2o_c", "ACONTb"),
            ("h2o_c", "ATPM"),
            ("h2o_c", "Biomass_Ecoli_core"),
            ("h2o_c", "CS"),
            ("h2o_c", "FBP"),
            ("h2o_c", "FUM"),
            ("h2o_c", "GLNabc"),
            ...
            ("lac__D_c", "LDH_D"),
            ("lac__D_e", "D_LACt2"),
            ("lac__D_e", "EX_lac__D_e"),
            ("mal__L_c", "MDH"),
            ("mal__L_c", "ME1"),
            ("mal__L_c", "ME2"),
            ("mal__L_e", "EX_mal__L_e"),
            ("mal__L_e", "MALt2_2"),
            ("nad_c", "ACALD"),
            ("nad_c", "AKGDH"),
            ("nad_c", "ALCD2x"),
            ("nad_c", "Biomass_Ecoli_core"),
            ("nad_c", "GAPD"),
            ("nad_c", "LDH_D"),
            ("nad_c", "MDH"),
            ("nad_c", "ME1"),
            ...
            ("o2_e", "EX_o2_e"),
            ("o2_e", "O2t"),
            ("oaa_c", "Biomass_Ecoli_core"),
            ("oaa_c", "CS"),
            ("oaa_c", "PPCK"),
            ("pep_c", "Biomass_Ecoli_core"),
            ("pep_c", "FRUpts2"),
            ("pep_c", "GLCpts"),
            ("pep_c", "PPC"),
            ("pep_c", "PYK"),
            ...
            ("ATPS4r", "h2o_c"),
            ("ATPS4r", "h_c"),
            ("Biomass_Ecoli_core", "adp_c"),
            ("Biomass_Ecoli_core", "akg_c"),
            ("Biomass_Ecoli_core", "coa_c"),
            ("Biomass_Ecoli_core", "h_c"),
            ("Biomass_Ecoli_core", "nadh_c"),
            ("Biomass_Ecoli_core", "nadp_c"),
            ("Biomass_Ecoli_core", "pi_c"),
            ("CO2t", "co2_c"),
            ("CS", "cit_c"),
            ("CS", "coa_c"),
            ("CS", "h_c"),
    ...
    def test_cobra2metexplore(self):
        ...
        model = self.ecoli.copy()
        json_string = cobra2metexplore(
            model, removeUnselectedGroups=True, groups="g27"
        )
